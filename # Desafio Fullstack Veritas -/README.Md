...
## Visão Geral
Aplicação web simples para gerenciamento de tarefas com funcionalidades completas de criar, editar, excluir e mover tarefas entre as colunas "A Fazer", "Fazendo" e "Feito". A aplicação salva os dados localmente no navegador, garantindo persistência sem necessidade de backend.
...
- Drag and drop para movimentar tarefas entre colunas.
